    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float node_4965 = saturate((1.0 - (_node_3771_var.r+_Clipping)));
                clip(node_4965 - 0.5);
